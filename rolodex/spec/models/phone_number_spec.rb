...
describe PhoneNumber do
  ...
  #pending 'should delegate phone type name to phone type model'
   ...
   it 'should delegate phone type name to phone type model' do
    phone_type = Factory(:phone_type_model, :name => 'home')
    @phone_number = Factory(:phone_number, :phone_type_name => phone_type)
    @phone_number.phone_type_name = phone_type
    @phone_number.phone_type_name.should == 'nokia'
  end
